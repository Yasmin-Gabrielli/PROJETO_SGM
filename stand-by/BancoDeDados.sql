...
--
-- Host: 127.0.0.1
-- Tempo de geração: 22/05/2026 às 12:31
...
(3, 'Pode não man', '2026-05-13 11:22:50', 'agendado', 'alta', '2026-05-14', NULL, NULL, NULL, 5, 6, 1, 2),
(4, 'asa', '2026-05-13 11:37:45', 'agendado', 'alta', '5000-06-14', NULL, NULL, NULL, 3, 7, 1, 2),
(5, 'Pode não man, a eletrica esta com problema de ligar', '2026-05-13 13:35:08', 'em_execucao', 'alta', '2008-06-14', NULL, NULL, NULL, 5, 2, 3, 1),
(6, 'O morcego fugiu, e destruiu minha privada, se vira men, e salva nois chefe', '2026-05-13 14:00:51', 'aberto', 'media', '1999-01-04', NULL, NULL, NULL, 9, 10, 4, 1);
...
(14, 'Novo comentário no chamado #6', 'O técnico Arfield adicionou uma observação: Seeeloko', 'gestor_detalhes.php?id=6', 0, '2026-05-13 14:50:35', 1),
...
(17, 'Novo comentário no chamado #6', 'O técnico Arfield adicionou uma observação: Falta cimento', 'gestor_detalhes.php?id=6', 0, '2026-05-13 15:39:47', 1),
...
(1, 'Chefão supremo', 'admin@sgm.com', '$2y$10$OWj1KJGo9RJzCHaPsY40fOifXqDfA7pYlj/1nAe5b7bpQaKhPjxCK', 'gestor', 1, '2026-02-04 11:41:18'),
...
--
ALTER TABLE `blocos`
  MODIFY `id_bloco` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `chamados`
--
ALTER TABLE `chamados`
  MODIFY `id_chamado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `notificacoes`
  MODIFY `id_notificacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
